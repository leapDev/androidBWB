...
import com.learning.leap.beginningtobabble.DownloadActivity;
import com.learning.leap.beginningtobabble.R;
import com.learning.leap.beginningtobabble.Utility;
import com.learning.leap.beginningtobabble.helper.LocalLoadSaveHelper;
import com.learning.leap.beginningtobabble.models.BabblePlayer;
...
public class UserInfoFragment extends Fragment {
       ...
       final EditText birthDayEditText = (EditText)view.findViewById(R.id.userProfileFragmentBirtdayEditText);
        ...
        pleaseTapHereTextView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent whyIntent = new Intent(getActivity(), com.learning.leap.beginningtobabble.settings.WhyActivity.class);
    ...
    public static class SavePlayer extends AsyncTask<Void,Void,Boolean>{
        ...
        protected void onPostExecute(Boolean result) {
            ...
            if (result){
                if (mUserInfoFragment.get() != null) {
                    if (newUser && !noPrompts) {
                        mUserInfoFragment.get().getFilesForDownload(mNotifications, noPrompts, mBabblePlayer);
                    }else if (newUser && noPrompts){
                        Utility.displayAlertMessage(R.string.BabbleError,R.string.noPromptsForUser,mContext);
                    } else{
                        Utility.addCustomEvent(Constant.CHANGE_PROFILE_SETTINGS);
