package com.example.ryangunn.beginningtobabble.library;
...
import com.example.ryangunn.beginningtobabble.PlayTodayFragment;
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        mHomeImageView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                LibarayFragment.this.getActivity().finish();
            }
        });
        if (index == 0) {
            ...
            public void onClick(View view) {
                if (isPlaying){
                   pauseMediaPlayer();
                    ...
                    try {
                        NotificationFunctions.playSound(mNotfications.get(index),mediaPlayer,LibarayFragment.this);
                    } catch (Exception e) {
                        e.printStackTrace();
                    }
                }
