...
import com.learning.leap.beginningtobabble.helper.AnswerNotification;
...
public class VoteActivity extends AppCompatActivity implements MediaPlayer.OnPreparedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Log.d("did", "onCreate: " + numberOfTips); Realm realm = Realm.getDefaultInstance();
        ...
        mPlaySoundImageView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (isPlaying){
                    ...
                    try {
                        NotificationFunctions.playSound(notificationAtRandomIndex,mediaPlayer,VoteActivity.this,VoteActivity.this);
                    } catch (Exception e) {
                        e.printStackTrace();
                    }
                }
        ...
        mVoteThumbDownImageView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
               ...
               homeIntent();
                Utility.addCustomEventWithNotification(Constant.THUMBS_DOWN,notificationAtRandomIndex.getSoundFileName());
            }
        });
        ...
        mVoteThumbUpImageView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                homeIntent();
                Utility.addCustomEventWithNotification(Constant.THUMBS_UP,notificationAtRandomIndex.getSoundFileName());
            }
        });
